...
test("typeof", function() {
    equal(typeof({}), typeof({}), 'what is the type of an empty object?');
    equal(typeof(''), typeof('apple'), 'what is the type of a string?');
    equal(typeof(5), typeof(-5), 'what is the type of -5?');
    equal(typeof(false), typeof(false), 'what is the type of false?');
});
