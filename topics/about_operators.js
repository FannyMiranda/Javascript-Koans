...
test("addition", function() {
  ...
  equal(result + 0, result, "What is the value of result?");
});
...
test("assignment addition", function() {
  ...
  equal(result += i, result, "What is the value of result?");
});
...
test("assignment subtraction", function() {
  ...
  equal(result -=5, result, "What is the value of result?");
});
...
test("modulus", function() {
  ...
  result %= x;
  equal(result %x, result, "What is the value of result?");
});
